...
const EventCard = ({ event }) => {
  const { image, name, description, day, time, location, 'ticket-price': ticketPrice } = event;
  return (
    <GridItem w="100%" h="100%" mb="6">
      <Box
        maxW="100%"
        borderWidth="1px"
        borderRadius="lg"
...
export const Home = () => {
  ...
  return (
    <Box p="6">
      <Heading as="h1" textAlign="left" mb="6">
        Upcoming Events
      </Heading>
      <EventList events={eventData.home} />
    </Box>
  );
};